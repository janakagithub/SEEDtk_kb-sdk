...
{
    # Service SEEDtk requires authentication.
    ...
    my @result;
    {
        ...
        my $stderr = SEEDtk::SEEDtkServerStderrWrapper->new($ctx, $get_time);
        $ctx->stderr($stderr);
...
package SEEDtk::SEEDtkServerContext;

use strict;

=head1 NAME

SEEDtk::SEEDtkServerContext
...
package SEEDtk::SEEDtkServerStderrWrapper;
