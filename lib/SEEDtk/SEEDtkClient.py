...
class SEEDtk(object):
    ...
    def missing_roles(self, workspace_name, contigset_id, genome_id, genome_name, json_rpc_context = None):
        ...
        resp = self._call('SEEDtk.missing_roles',
                          [workspace_name, contigset_id, genome_id, genome_name], json_rpc_context)
        return resp[0]
