...
<pre>
$params is a SEEDtk.FilterContigsParams
$return is a SEEDtk.FilterContigsResults
FilterContigsParams is a reference to a hash where the following keys are defined:
	workspace has a value which is a SEEDtk.workspace_name
...
FilterContigsResults is a reference to a hash where the following keys are defined:
	new_contigset_ref has a value which is a SEEDtk.ws_contigset_id
