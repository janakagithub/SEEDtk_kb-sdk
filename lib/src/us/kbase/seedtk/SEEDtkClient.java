...
public class SEEDtkClient {
     ...
     * validity.
     */
    public SEEDtkClient(URL url, AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public SEEDtkClient(URL url, String user, String password) throws UnauthorizedException, IOException {
